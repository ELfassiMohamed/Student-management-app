  ...
  <div class="navbar navbar-inverse" style="background-color: #435d7d;>
            ...
            <div class="col-lg-12">
                ...
                <div class="navbar-collapse collapse" id="mobile_menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ Route('enseignant.chefdep') }}">Dashboard</a></li>
   ...
   <div class="containeeer">
            ...
            <div class="card">
                ...
                <div class="forms">
                    <div class="inputs"> <h4>Nom </h4>{{ $user->name }}</div>
                    <div class="inputs"> <h4>Prenom</h4>{{ $user->prenom }}</div>
                    <div class="inputs"> <h4>Departement</h4>{{ $user->dept }}</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">            
                    <h4 class="modal-title">Editer Profile</h4>
